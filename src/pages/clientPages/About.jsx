...
const values = [
  {
    ...
    description:
      "We connect clients with verified, skilled Afro and curly hairstylists who care about quality, professionalism, and delivering exceptional results every time",
    image: values1,
  },
  {
    id: 2,
    ...
    description:
      "Crownity is more than a platform its a community that celebrates Black beauty, supports hairstylists, and empowers clients to feel confident in their crown",
    image: values2,
  },

  {
    ...
    description:
      "We take pride in representing diverse textures and styles with authenticity, creating a space where every curl, coil, and braid is valued and celebrated.",
    image: values3,
  },
];
      ...
      <div className="bg-brown-31">
        <div className="container">
          <div className="py-20 flex flex-col justify-center items-center">
            ...
            <h2 className=" sm:text-[40px] text-[22px] lg:text-[45px] font-playfair text-light-brown-c1 font-bold leading-none mb-4  max-w-[610px] mb-[32px]">
              The story behind Crownity – celebrating every crown 👑
            </h2>

            <Link to="/contact">
              <ButtonSquare className="bg-background text-brown-A43  text-sm rounded-none">
                CONTACT US
              </ButtonSquare>
            </Link>
          </div>
        ...
        <div className="container">
          <div className=" py-14 md:py-24    xl:py-40">
            <div className="flex flex-col gap-14 justify-center items-center">
              <div>
                <p className="font-manrope  text-sm font-semibold text-brown-A43  mb-[10px]">
                  Our Values
                </p>
                <h2 className=" sm:text-[40px] text-[22px] lg:text-[45px] font-playfair text-black-14 font-bold leading-none mb-4   ">
                  The values we stand for at Crownity
                </h2>
              </div>
