          ...
          <div className="py-[45px] md:px-[40px] bg-background rounded-[10px]">
            <div className="flex flex-col gap-[20px]">
              <div className="grid grid-cols-12 gap-[20px] ">
                <div className="col-span-12 md:col-span-8 rounded-3xl aspect-[2/1]">
                  <img
                    src={detail1}
                    alt="detail1"
              ...
              <div
                className={`${
                  activeTab === 0 ? "gap-[20px]" : "gap-[0px]"
                } flex flex-col shadow-2xl  px-[26px] py-[20px] rounded-[15px]  `}
              >
                <div
                  ...
                  onClick={() => toggleTab(0)}
                >
                  <p className="text-black-black  font-playfair font-bold  sm:text-[30px] text-[20px]">
                    Hairstlist Details
                  </p>
                ...
                >
                  <div className="flex flex-col md:gap-[20px] gap-[10px] md:mb-[51px] mb-[20px] ">
                    <div className="flex sm:flex-row flex-col justify-between items-center">
                      <div>
                        <p className=" sm:text-[25px] text-[20px] sfont-playfair font-bold text-black-14">
                          Crown by Amara
                        </p>
                      </div>
                      <div className="flex gap-[20px] items-center">
                        <div className="flex items-center gap-[10px] text-brown-A43">
                          ...
                          <p className="md:text-[25px]  text-[13px] font-manrope font-normal ">
                            4.5
                          </p>
                        </div>
                        ...
                        <div>
                          {" "}
                          <p className="md:text-lg text-[13px] font-playfair font-bold text-gray-55">
                            104 Reviews.
                          </p>
                        </div>
                      </div>
                    ...
                    <p className="font-manrope md:text-base text-[13px] font-semibold text-gray-55  text-left  md:leading-10 leading-5 ">
                      At Crown by Amara, we believe your hair is your crown, and
                      it deserves the best care. With years of professional
                      experience, we specialize in modern cuts, vibrant
                      coloring, bridal styling, and treatments that bring life
                      back to your hair. Our mission is to create looks that
                      reflect your personality while keeping your hair healthy
                      and radiant. Whether it’s a quick trim, a bold
                      transformation, or the perfect style for your big day,
                      Crown by Amara ensures every client leaves with confidence
                      and a smile. 🌸.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1    lg:grid-cols-3  md:gap-[104px]  gap-[10px] md:gap-[80px] sm:gap-[60px] xs:gap-[30px] md:mb-[111px] mb-[20px]">
                    <div className="flex flex-col gap-[20px] items-start justify-start text-left  border-b-[1px] lg:border-b-0   lg:border-r-[1px] border-white-d9">
                      <p className="sm:text-[35px] text-[12x] sm:font-playfair font-bold text-brown-A43">
                        Services Offered
                      </p>

                      <div className=" ">
                        <ul className="flex flex-col gap-[10px] list-disc list-inside">
                          <li className="md:text-2xl text-[13px] font-manrope font-normal text-gray-55">
                            Women's Haircut
                          </li>
                          <li className="md:text-2xl text-[13px] font-manrope font-normal text-gray-55">
                            Bridal Hair Styling
              ...
              >
                ...
                <div
                  className={`overflow-hidden transition-all duration-700 ease-in-out  ${
                    activeTab === 1
                      ? "max-h-[2000px] opacity-100   pt-[45px]"
                ...
                >
                  <div className="flex flex-col gap-[20px]">
                    <div className="flex justify-between items-center">
                      <div>
                        <span class="bg-green-100 text-green-800 text-lg font-medium me-2 px-8 py-1 rounded-full  ">
                          Active
                        </span>
                      </div>
                    </div>
                    <div className="grid grid-cols-1    lg:grid-cols-3  md:gap-[104px]  gap-[10px] md:gap-[80px] sm:gap-[60px] xs:gap-[30px] md:mb-[111px] mb-[20px]">
                      <div className="flex flex-col gap-[20px] items-start justify-start text-left   lg:border-b-0   lg:border-r-[1px] border-white-d9">
                        ...
                        <div className=" ">
                          <ul className="flex flex-col gap-[10px] list-disc list-inside">
                            ...
                            <li className="md:text-2xl text-[13px] font-manrope font-normal text-black-14  gray-55">
                      ...
                      <div className="flex  ">
                        <div className="flex flex-col gap-[20px] items-start justify-start text-left">
                          ...
                          <div className="">
                            <ul className="flex flex-col gap-[10px] ">
                              <li className="md:text-2xl text-[13px] font-playfair font-normal text-gray-55">
                                789531`
                              </li>
                            </ul>
                          </div>
                    ...
                    <div className="flex flex-col  gap-[30px] mb-[24px]">
                      ...
                      <p className="font-manrope md:text-2xl text-[13px] font-playfair text-gray-55  text-left  md:leading-10 leading-5 ">
                        Please be on time and bring all the accessories that
                        make my hairstyle perfect, with or without them. Also,
                        make sure to bring the original color for my hair..
                      </p>
                    </div>

                    <div className="w-full">
                      <ButtonSquare
                        className={`w-full bg-transparent border border-brown-A43 text-brown-A43  py-[32px]  px-[110px] font-extrabold text-[14px]  bg-brown-A43 text-background  `}
                        variant="secondary"
                        onClick={(e) => {
                          e.stopPropagation();
                          setIsOpen(true);
          ...
          >
            ...
            >
              ...
              <div className="py-4 flex flex-col gap-4 justify-center  px-0  px-[30px] 2xl:px-[100px]  ">
                ...
                <div className="   md:text-[20px] text-[15px]  md:text-[20px]  xl:text-[20px] font-poppins font-extrabold text-black  text-center">
                  {" "}
                  Your Service Completed
                </div>
                <p className="   md:text-[18px] text-[15px] font-poppins font-normal text-gray-55 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                  ...
                  >
                    <ButtonSquare
                      className={`w-full bg-transparent border border-brown-A43 text-brown-A43  py-[32px] px-[110px]  font-extrabold text-[14px] font-manrope ${
                        activebtn === 1 ? "bg-brown-A43 text-background" : ""
                  ...
                  >
                    <ButtonSquare
                      className={`w-full bg-transparent border border-brown-A43 text-brown-A43  py-[32px]  px-[110px] font-extrabold text-[14px] font- ${
                        activebtn === 2 ? "bg-brown-A43 text-background" : ""
                      } hover:bg-brown-A43 hover:text-background`}
                      variant="secondary"
                    >
                      Completed
