      ...
      <div className='bg-brown-31'>
        <div className='container'>
          <div className='py-20 flex flex-col justify-center items-center'>
            <p className='font-manrope  text-sm font-semibold text-background  mb-[2px]'>GET IN TOUCH WITH US</p>
            <h2 className=' sm:text-[40px] text-[22px] lg:text-[45px] font-playfair text-light-brown-c1 font-bold leading-none mb-4  max-w-[545px] mb-[32px]'>We’re Here to Help You Shine, Anytime ✨</h2>
          </div>
        </div>
      </div>
        ...
        <div className='container'>
          <div className='grid  grid-cols-1  md:grid-cols-2  gap-[112px]  px-0  md:px-[60px] lg:px-[150px]    xl:px-[240px]  py-[160px] '>
            ...
            <div className='flex flex-col gap-10 items-start justify-start text-left'>
              ...
              <div>
                <p className='font-manrope  text-sm font-semibold text-brown-A43  mb-[2px]  text-center lg:text-left'>Get in Touch!</p>
                <h2 className=' sm:text-[40px] text-[22px] lg:text-[45px] font-playfair text-black-14 font-bold leading-none mb-[30px]  text-center lg:text-left '>Reach out to Crownity Support</h2>
                <p className='font-manrope text-base font-semibold text-gray-55  text-left  leading-5 xl:max-w-[700px]'>Whether you’re a Hairstylist looking to join, or a client searching for the perfect match, we’d love to hear from you.</p>
              </div>
