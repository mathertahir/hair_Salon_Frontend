...
//     const url = id === '0' ? "/auth/login" : "api/auth/business/login";
...
//                 // const subscription = response.data?.responseData?.data.subscription;
...
//                             <Link to={`/signin-client/${id}`} className='w-full sm:w-auto'>
...
//                             <Link to={`/signin-client/${id}`} className='w-full sm:w-auto'>      <ButtonSquare className=' px-[32px] py-[11px] flex justify-center items-center border-white-E9 border-[2px]  rounded-[8px] w-full sm:w-auto' variant='outline' >
//                                 <div className=' w-[24px] h-[24px]'>
...
//                             <p className='text-blueB8 text-[15px] font-poppins font-semibold'>Don't have an account? <Link to={`/signup-client/${id}`} className='hover:-translate-y-[2px] text-brown-A43 font-semibold font-poppins'>SignUp</Link></p>
//                         </div>
//                     </div>
