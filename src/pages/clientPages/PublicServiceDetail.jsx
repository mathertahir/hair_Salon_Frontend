                    ...
                    <div className='py-[40px] '>
                        ...
                        <div className='flex flex-col gap-[20px] mb-[51px] '>
                            ...
                            <div className='flex sm:flex-row flex-col justify-between items-center'>
                                <div>
                                    <p className=' sm:text-[35px] text-[20px] sfont-playfair font-bold text-black-14'>{service?.business?.businessName}</p>
                                </div>
                            ...
                            <p className='font-manrope text-base font-semibold text-gray-55  text-left  leading-10 '>
                                {service?.business?.businessDescription}</p>
                        </div>
                        ...
                        <div className='flex flex-col gap-[20px] items-start justify-start text-left mb-[111px]'>
                            ...
                            <div className='w-full'>
                                <MyMap key="salon-map" coordinates={service?.business?.businessLocation.coordinates} />
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col gap-[80px]'>
                                    ...
                                    <div className='flex flex-col gap-[20px] items-start justify-start text-left'>
                                        ...
                                        <div className=' '>
                                            <ul className='flex flex-col gap-[10px] '>
                                                ...
                                                <li className='text-2xl font-manrope font-normal text-gray-55'>{service?.business?.operatingDays}</li>
                                                <li className='text-2xl font-manrope font-normal text-gray-55'>{service?.business?.operatingHours}</li>
                            ...
                            <div className='flex flex-col gap-[10px]'>
                                <p className=' sm:text-[25px] text-[20px] font-playfair font-bold text-brown-A43'>Service Detail</p>

                                <div className='flex flex justify-between gap-[5px]'>
                                    <p className=' sm:text-[25px] text-[20px] font-playfair font-bold text-black-14'>Name </p>
                                    <p className=' sm:text-[25px] text-[20px] font-manrope font-bold text-brown-A43'>{service?.name} </p>

                                </div>

                                <div className='flex flex justify-between gap-[5px]'>
                                    <p className=' sm:text-[25px] text-[20px] font-playfair font-bold text-black-14'>Price </p>
                                    <p className=' sm:text-[25px] text-[20px] font-manrope font-bold text-brown-A43'>${service?.price} </p>

                                </div>
                                <div className='flex flex flex-col gap-[10px]'>
                                    <p className=' sm:text-[25px] text-[20px] font-playfair font-bold text-black-14'>Description </p>
                                    <p className=' sm:text-[15px] text-[15px] font-manrope  text-black-14'>${service?.description} </p>
