...
//     // Mount effect: initialize from query param and fetch immediately
//     useEffect(() => {
//         const param = queryParams.get("searchParam") || "";
//         console.log(param.length, "Coming Param");
//         setSearchParam(param);
//         fetchServices(param); // Fetch with param or empty string
//     }, [queryParams]);

//     // Fetch when searchParam, pagination or filter changes
//     useEffect(() => {
...
//         // fetch will auto trigger via useEffect
//     };
