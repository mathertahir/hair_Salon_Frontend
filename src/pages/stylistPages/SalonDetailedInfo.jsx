          ...
          <div>
            <div className="flex justify-between bg-brown-A43-o2 rounded-[50px] mb-8">
              <button
                ...
                className={`${
                  activeTab === 1 ? "text-background" : "text-black"
                } font-bold md:text-[18px] text-[12px] font-manrope ${
                  activeTab === 1 ? "bg-brown-A43" : "bg-transparent"
                } rounded-[50px] flex justify-center items-center w-1/2 py-[18px] px-[20px] transition-all duration-300 cursor-pointer`}
              >
                My Account
              </button>
              <button
                ...
                className={`${
                  activeTab === 2 ? "text-background" : "text-brown-black"
                } font-bold md:text-[18px] text-[12px] font-manrope ${
                  activeTab === 2 ? "bg-brown-A43" : "bg-transparent"
                } rounded-[50px] flex justify-center items-center w-1/2 py-[18px] px-[20px] transition-all duration-300 cursor-pointer`}
              >
                Subscriptions
              </button>
            ...
            <div className="tab-content">
              {activeTab === 1 && (
                ...
                <div className="flex flex-col gap-[20px]">
                  <div
                    className={`${
                      activeAccordion === 0 ? "gap-[20px]" : "gap-[0px]"
                      ...
                      <div className="flex flex-col gap-[50px]">
                        <div className="grid grid-cols-1  lg:grid-cols-2   xl:grid-cols-3  md:gap-[104px]  gap-[10px] md:gap-[80px] sm:gap-[60px] xs:gap-[30px] w-full">
                          <div className="flex flex items-center gap-[10px]  justify-start text-left      ">
                            <p className="sm:text-[25px] text-[12px] sm:font-playfair font-bold text-brown-A43">
                              Name :
                            </p>

                            <div className=" ">
                              <p className="md:text-2xl text-[13px] font-manrope font-normal text-gray-55">
                                Adam Scout
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="flex flex-col  gap-[30px] mb-[24px]">
                          <p className="sm:text-[30px] text-[12px] sm:font-playfair font-bold text-black-14">
                            Description
                          </p>

                          <p className="font-manrope md:text-2xl text-[13px] font-playfair text-gray-55  text-left  md:leading-10 leading-5 ">
                            Crownity connects hairstylists (especially braiders)
                            with clients across Canada. Clients can easily find
                            and book stylists, while stylists showcase their
                            work and grow their business. The platform must be
                            modern, mobile-friendly, SEO-optimized, and fully
                        ...
                        <div className="grid sm:grid-cols-2 grid-cols-1 gap-4 w-full">
                          ...
                          >
                            <Link to="/">
                              <ButtonSquare
                                className={`w-full bg-transparent  text-brown-A43  py-[32px] px-[110px]  font-extrabold text-[14px] font-manrope ${
                                  activebtn === 1
                                    ? "bg-brown-A43 text-background"
                                    : "bg-brown-A43-o20 text-brown-A43"
                  ...
                  <div
                    className={`${
                      activeAccordion === 1 ? "gap-[20px]" : "gap-[0px]"
                    } flex flex-col shadow-2xl  px-[26px] py-[20px] rounded-[15px]  `}
                  >
                    <div
                      className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors duration-200"
                      ...
                      <div className="flex flex-col gap-[20px]">
                        <div className="grid grid-cols-1    lg:grid-cols-3  md:gap-[104px]  gap-[10px] md:gap-[80px] sm:gap-[60px] xs:gap-[30px] md:mb-[111px] mb-[20px]">
                          <div className="flex flex-col gap-[20px] items-start justify-start text-left  border-b-[1px] lg:border-b-0   lg:border-r-[1px] border-white-d9">
                            <p className="sm:text-[35px] text-[12px] sm:font-playfair font-bold text-brown-A43">
                            ...
                            <div className="flex gap-3 items-center flex-wrap">
                              <div className="w-[100px] h-[100px] relative rounded-lg">
                                ...
                                <div className="absolute top-[3px] right-[5px]">
                                  <span class=" text-background text-xs font-medium me-2 px-2.5 py-0.5 rounded-full bg-green-900 ">
                                    Verified
                                  </span>
                                </div>
                              </div>
                          ...
                          <div className="flex  ">
                            <div className="flex flex-col gap-[20px] items-start justify-start text-left">
                              ...
                              <div className="flex gap-3 items-center flex-wrap">
                                <div className="w-[100px] h-[100px] relative rounded-lg aspect-square">
                                  <img
                                    src={gallery1}
                                    alt=""
                                    className="w-full h-full rounded-lg"
