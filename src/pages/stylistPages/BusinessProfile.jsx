    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center h-64">
                <p className="text-lg text-gray-600 font-manrope">Loading business profile...</p>
            </div>
        );
    }
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2 flex-wrap">
                    ...
                    <div
                        ...
                        aria-disabled={true}
                    >
                        <MyMap key="salon-map" coordinates={businessProfile?.businessLocation?.coordinates} />
                ...
                <div className="flex flex-col xs:flex-row justify-between xs:items-center gap-2 flex-wrap">
                    ...
                    <PhotoProvider>
                        <div className="flex gap-2 flex-wrap">
                            {Array.isArray(businessProfile?.businessPhotos) && businessProfile.businessPhotos.length > 0 ? (
                    ...
                    <PhotoProvider>
                        <div className="flex gap-2 flex-wrap">
                            ...
                            {businessProfile?.businessRegistrationDoc?.url ? (
                                <PhotoView src={businessProfile.businessRegistrationDoc.url} className="border-none">
                                    <img
