                                ...
                                <div className='flex flex-col gap-20 flex-1'>
                                    <div className='flex flex-col gap-10 '>
                                        <div className='flex flex-col gap-3'>
                                            <p className='md:text-[40px] text-[20px]   font-bold text-black-14 font-playfair  group-hover:text-background transition-colors duration-300 ease-in-out'>$19.99/mo</p>
