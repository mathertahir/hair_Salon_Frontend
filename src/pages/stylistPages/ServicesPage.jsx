...
const ServicesPage = () => {
  ...
  const userSubscription = localStorage.getItem("subscriptionInfo")
    ? JSON.parse(localStorage.getItem("subscriptionInfo"))
    : null;
  ...
  const handleServiceSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      if (
        values.servicePhoto.length > 0 &&
        values.servicePhoto[0] instanceof File
      ) {
  ...
  return (
    <div>
      <div className="p-4 flex flex-col gap-8">
        {/* Header */}
        {userSubscription &&
          userSubscription.subscriptionStatus === "expired" && (
            <div className="flex  flex-col gap-4">
              ...
              <div className="w-max">
                <Link to="/business/subscription">
                  <ButtonSquare
                    className="w-max bg-transparent text-brown-A43 py-[32px] px-[60px] font-extrabold text-[14px] font-manrope hover:bg-brown-A43 text-black-14 bg-brown-A43-o20 hover:text-background"
                    variant="secondary"
                  >
                    Renew Subscription
                  </ButtonSquare>
        ...
        <div className="flex justify-between items-center">
          ...
          <ButtonSquare
            className="bg-brown-A43 text-white flex gap-2  disabled:bg-bg-brown-A43-o20 "
            onClick={() => {
              setEditingService(null);
              setIsModalOpen(true);
            }}
                ...
                services.map((service, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 flex items-center gap-3">
                      ...
                      <Link
                        to={`/business/viewService/${service._id}`}
                    ...
                    <Form className="flex flex-col gap-4">
                      ...
                      <div>
                        <FileUploadField
                          ...
                          setFiles={(files) =>
                            setFieldValue("servicePhoto", files)
                          }
                          maxFiles={1}
                        />
